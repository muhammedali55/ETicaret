...
namespace ETicaret.Utility
{
    public class CustumErrors: IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordTooShort(int length) { return new IdentityError { Code = nameof(PasswordTooShort), Description = $"Şifre Uzunululu En az {length} Karakter olmalıdır." }; }
        ...
        public override IdentityError PasswordRequiresLower() { return new IdentityError { Code = nameof(PasswordRequiresLower), Description = "Şifre İçinde En az bir adet Küçük harf kullanmalısınız ('a'-'z')." }; }
        public override IdentityError PasswordRequiresUpper() { return new IdentityError { Code = nameof(PasswordRequiresUpper), Description = "Şifre İçinde En az bir adet Büyük harf kullanmalısınız ('A'-'Z')." }; }
